...
export declare enum DepthOfMarketDataFormat {
    'FULL' = "FULL"
}
...
export type DepthOfMarketMessage = DepthOfMarketSetupMessage | DepthOfMarketConfigMessage | DepthOfMarketSnapshotMessage;
export declare const isDepthOfMarketMessage: (message: DXLinkChannelMessage) => message is DepthOfMarketMessage;
